<#
.SYNOPSIS
    Ejecuta el Liberador de espacio en disco (cleanmgr) en Windows.

.DESCRIPTION
    Ejecuta el Liberador de espacio en disco (cleanmgr) en todas las unidades fijas del sistema
    de forma 100% silenciosa mediante tareas programadas temporales ejecutadas como SYSTEM.
...
.NOTES
    Name: Script - Full cleanup (para updates) (Windows).ps1
